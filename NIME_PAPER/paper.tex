...
I'd like to define terms such as VSTs, audio effects, Synthesizers, paramters and presets here. I throw these terms around a lot and I think some might be confused by their meaning.
...
\caption{Mel-spectrum representation of a randomly generated sample. Bigger stacks give us more complex signals, but we find that ever stacks of size 1 can be powerful with the right parameters. }
