...
\begin{enumerate}[label=\roman*]
  ...
  \item Rendering at high sampling rates with little performance issues: A significant number of untrained ears can detect a change in quality between sampling rates of 192 khz and 44.1 khz \cite{reiss2016meta}, with a dramatic increase following extensive training. Thus we can assume that most producers would prefer their audio samples to have as high of a resolution as possible. However, most commonly to speed up performance, the standard sampling rate in most audio generation work neural networks appears to be 24 khz or less \cite{yamamoto2019parallel,oord2017parallel,aouameur2019neural,ramires2019timbfeat}
